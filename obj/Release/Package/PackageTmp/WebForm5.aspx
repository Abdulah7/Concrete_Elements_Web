...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p style="position:absolute; top: 707px; left: 468px;">
        ZRAČNIK
    </p>

   <img style="position:absolute; top: 757px; left: 467px; border: thin solid #FF0000;" src="Images/zracnik11.JPG"/>
      <p style="position:absolute; top: 1051px; left: 470px;">
        TEHNIČKI PODACI
    </p>

    
   <img style="position:absolute; top: 1091px; left: 472px;" src="Images/ZRACNIKT.JPG"/>

     <h5 style="position:absolute; top: 1160px; left: 462px; bottom: 165px;">*Cijena u franko skladištu. Nudimo usluge prijevoza na adresu kupca.
    </h5>
