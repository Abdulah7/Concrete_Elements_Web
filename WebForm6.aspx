...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div>
        <img src="Images/skrajnica1.JPG" style="position:absolute; top: 691px; left: 483px; border: thin solid #FF0000;" />
          <img src="Images/skrajnica2.JPG" style="position:absolute; top: 685px; left: 778px; border: thin solid #FF0000;" />
        <img src="Images/TEHSkrajnica.JPG" style="position:absolute; top: 982px; left: 489px; margin-top: 0px;" />


         <p style="position:absolute; top: 947px; left: 491px; height: 23px; width: 163px; right: 526px;">
        TEHNIČKI PODACI
              </p>
              <h5 style="position:absolute; top: 1073px; left: 484px; bottom: 165px; width: 388px;">*Cijena u franko skladištu. Nudimo usluge prijevoza na adresu kupca.
    </h5>
    ...
    <p style="position:absolute; top: 654px; left: 486px;">
          SKRAJNICA
